    ...
    translation: {
      ...
      cameras: {
        ...
        bulk: {
          ...
          format_desc: "Paste your data using comma (,) or tab separation. Each line represents one camera.",
          guide_name: "Camera Name: Required, must be unique in the list.",
          guide_group: "Group: Optional, defaults to 'All Cameras' if empty or not found.",
          guide_pos: "Lat/Long: Optional, defaults to 13.75, 100.50 (Bangkok) if omitted.",
          guide_rtsp: "Main RTSP: Required, must be a valid RTSP URL.",
          guide_sub: "Sub RTSP: Optional URL for map preview or sub-stream.",
    ...
    translation: {
      ...
      cameras: {
        ...
        bulk: {
          ...
          format_desc: "วางข้อมูลของคุณโดยใช้เครื่องหมายคอมม่า (,) หรือ Tab ในการแบ่งคอลัมน์ แต่ละบรรทัดคือ 1 กล้อง",
          guide_name: "ชื่อกล้อง: จำเป็นต้องระบุ และต้องไม่ซ้ำกันในรายการ",
          guide_group: "กลุ่ม: ไม่บังคับ หากไม่ระบุหรือหาไม่พบจะเข้ากลุ่ม 'All Cameras'",
          guide_pos: "พิกัด: ไม่บังคับ หากไม่ระบุจะใช้ค่าเริ่มต้น (13.75, 100.50 กรุงเทพฯ)",
          guide_rtsp: "RTSP หลัก: จำเป็นต้องระบุ และต้องเป็น URL ที่ถูกต้อง",
          guide_sub: "RTSP สำรอง: ไม่บังคับ สำหรับแสดงผลบนแผนที่หรือสตรีมรอง",
